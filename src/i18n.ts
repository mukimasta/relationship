...
const wordMap: Record<string, string> = {
  '窒息': 'Suffocating', '情绪绑架': 'Emotional blackmail', '控制': 'Controlling',
  '纠缠': 'Entangled', '疯狂拉扯': 'Tug of war',
  '讨好': 'People-pleasing', '过度依赖': 'Over-dependent', '患得患失': 'Anxious attachment',
  '争夺': 'Competing', '反复试探': 'Testing limits',
  '委屈': 'Aggrieved', '压抑': 'Suppressed', '紧绷': 'Tense',
  '焦虑': 'Anxious', '内耗': 'Inner drain',
  '隐忍': 'Enduring silently', '小心翼翼': 'Walking on eggshells', '不对等': 'Unequal',
  '勉强': 'Reluctant', '不踏实': 'Insecure',

  '全情投入': 'All in', '并肩作战': 'Side by side', '灵魂共振': 'Soul resonance',
  '热恋': 'Passionate love', '知己': 'Soulmate',
  '默契': 'In sync', '坦诚相待': 'Open & honest', '深度信任': 'Deep trust',
  '彼此激发': 'Mutual spark', '惺惺相惜': 'Kindred spirits',
  '看见': 'Seen', '亲近': 'Close', '被支持': 'Supported',
  '安全感': 'Feeling safe', '归属感': 'Belonging',
  '好感': 'Fond of', '欣赏': 'Admiration', '信任': 'Trust',
  '温暖': 'Warmth', '踏实': 'Grounded',

  '无所谓': 'Indifferent', '敷衍': 'Going through motions', '将就': 'Settling',
  '例行公事': 'Just routine', '不想经营': 'Don\'t want to try',
  '无力': 'Powerless', '心累': 'Emotionally tired', '回避': 'Avoidant',
  '冷淡': 'Cold', '疏离': 'Distant',
  '形同陌路': 'Strangers now', '冷暴力': 'Silent treatment', '名存实亡': 'In name only',
  '失望透顶': 'Deeply let down', '心寒': 'Disheartened',
  '废墟': 'Ruins', '彻底放弃': 'Given up', '耗竭': 'Depleted',
  '死心': 'Lost hope', '麻木': 'Numb',

  '有底气': 'Confident', '放心': 'At ease', '淡然': 'Serene',
  '自在': 'Comfortable', '安心': 'Peace of mind',
  '松弛': 'Relaxed', '淡而不疏': 'Light but connected', '君子之交': 'Gentle friendship',
  '细水长流': 'Slow & steady', '各自安好': 'Each at peace',
  '静好': 'Quietly good', '相忘江湖': 'Fondly apart', '偶尔想起': 'Comes to mind',
  '老友如故': 'Old friends still', '不联系也安心': 'Fine without contact',
  '无需维系': 'No upkeep needed', '祝福': 'Blessings', '释然': 'Letting go',
  '各自精彩': 'Thriving apart', '遥远的温暖': 'Distant warmth',
};
